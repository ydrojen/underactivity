...
public class ToolbarActivity extends UnderActivity {
  ...
  @Override public void onPostCreate(Bundle savedInstanceState) {
    ...
    getToolbar().setTitle(R.string.toolbar_default);
    getToolbar().setTitleTextColor(getResources().getColor(R.color.primaryDarkColor));
    text.setText(R.string.toolbar_default_text);
    code.setText(R.string.toolbar_default_code);

    findViewById(R.id.next).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        Intent i = new Intent(ToolbarActivity.this, CustomToolbarActivity.class);
        startActivity(i);
      }
    });
  }
