...
public class CustomToolbarActivity extends UnderActivity {
  ...
  @Override public void onPostCreate(Bundle savedInstanceState) {
    ...
    getToolbar().setTitle(R.string.toolbar_customlayout);
    getToolbar().setTitleTextColor(getResources().getColor(R.color.primaryDarkColor));
    TextView text = (TextView) findViewById(R.id.text);
    TextView code = (TextView) findViewById(R.id.code);
    text.setText(R.string.toolbar_customlayout_text);
    code.setText(R.string.toolbar_customlayout_code);

    findViewById(R.id.next).setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        Intent i = new Intent(CustomToolbarActivity.this, ToolbarDrawerActivity.class);
        startActivity(i);
      }
    });
  }
