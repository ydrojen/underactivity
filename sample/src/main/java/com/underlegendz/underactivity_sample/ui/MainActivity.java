...
public class MainActivity extends BaseActivity {
  ...
  protected ActivityBuilder configureActivityBuilder(ActivityBuilder builder) {
    return super.configureActivityBuilder(builder)
        .setToolbarScrollFlags(ActivityBuilder.SCROLL_FLAG_SCROLL
            | ActivityBuilder.SCROLL_FLAG_SNAP
            | ActivityBuilder.SCROLL_FLAG_ENTER_ALWAYS);
  }

  @Override
  public void onPostCreate(Bundle savedInstanceState) {
    super.onPostCreate(savedInstanceState);
    setFragment(SampleDataListFragment.newInstance());
  }
}
