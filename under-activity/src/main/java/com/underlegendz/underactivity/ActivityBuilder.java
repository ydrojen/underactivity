...
public final class ActivityBuilder {
   ...
   */
     ...
     * @return builder.
     */
    public ActivityBuilder enableCoordinatorAppBarLayout(boolean enableCoordinatorAppBarLayout) {
     ...
     * @return builder.
     */
    public ActivityBuilder setDrawerNavigationViewHeader(@LayoutRes Integer drawerNavigationViewHeaderResource) {
     ...
     * @return builder.
     */
    public ActivityBuilder setDrawerNavigationViewMenuResource(@MenuRes Integer drawerNavigationViewMenuResource) {
     ...
     * @return builder.
     */
    public ActivityBuilder setDrawerNavigationViewBackgroundColor(@ColorInt Integer drawerNavigationViewBackgroundColor) {
     ...
     * @return builder.
     */
    public ActivityBuilder setEndDrawerCustomLayout(@LayoutRes Integer endDrawerCustomLayoutResource) {
     ...
     * @return builder.
     */
    public ActivityBuilder setEndDrawerNavigationViewHeader(@DrawableRes Integer endDrawerNavigationViewHeaderResource) {
     ...
     * @return builder.
     */
    public ActivityBuilder setEndDrawerNavigationViewMenuResource(@MenuRes Integer endDrawerNavigationViewMenuResource) {
     ...
     * @return builder.
     */
    public ActivityBuilder setEndDrawerNavigationViewBackgroundColor(@ColorInt Integer endDrawerNavigationViewBackgroundColor) {
     ...
     * @return builder.
     */
    public ActivityBuilder setToolbarTabLayoutBackgroundColor(@ColorInt Integer toolbarTabLayoutBackgroundColor) {
